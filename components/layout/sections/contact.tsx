...
export const ContactSection = () => {
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        const mailToLink = `mailto:biz@itembox.kr?subject=${subject}&body=Hello I am ${firstName} ${lastName}, my Email is ${email}. %0D%0A${message}`;
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Input type="email" placeholder="biz@itembox.kr" {...field} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
